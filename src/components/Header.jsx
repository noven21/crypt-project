		...
		<header>
			<div className='h-[70vh]  flex items-center justify-center flex-col '>
				...
				<p className='text-lg font-normal text-center'>
					The best Tracking Cryptocurrency assets{' '}
					<br />
					Signup now to keep up to date on your
				...
				<div className=' flex items-center w-full justify-center p-4'>
					...
					<Link to='/signup'>
						<button className='px-5 py-2 font-bold w-full my-2 p-3 bg-button text-btnText rounded-2xl shadow-xl'>
							Sign Up
						</button>
					</Link>
				</div>
